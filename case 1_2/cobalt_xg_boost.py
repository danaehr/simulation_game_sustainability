...
df = pd.read_csv("./data/1_cleaned/Cobalt_Price_2026_cleaned.csv")
...
for supplier in suppliers:
    ...
    # Parameter choice:
    # - n_estimators=50 reduced overfitting while still
    #   allowing the model to capture important patterns
    # - max_depth=5 improved performance for the more
    #   volatile Cobalt suppliers without becoming too unstable
    # - learning_rate=0.2 allowed faster and more aggressive
    #   learning, which matched the stronger dynamics of
    #   the Cobalt price series
...
xgb_forecast_df.to_csv(
    "./data/3_predictions/cobalt_forecast_xgboost.csv"
)

results_df = pd.DataFrame(results)

results_df.to_csv(
    "./data/3_predictions/cobalt_xgboost_model_evaluation.csv",
    index=False
)
